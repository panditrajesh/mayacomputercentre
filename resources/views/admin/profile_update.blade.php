                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="center_code" value="{{ $data->cl_code }}"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="center_name" required
                                            value="{{ $data->cl_center_name }}" class="form-control" name=""
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" value="{{ $data->cl_cin_no }}" class="form-control"
                                            name="cin_no" placeholder="CIN No">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-3">
                                        <img style="    width: 80px;height: 86px;"
                                            src="{{ asset('admin/center_image/') . '/' . $data->cl_photo }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-6">
