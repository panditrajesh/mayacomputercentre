                    ...
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body pt-0">
                            <div class="auth-logo">
                                ...
                                <a href="index" class="auth-logo-dark">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <span class="avatar-title rounded-circle bg-light">
                                            <img src="assets/images/apprise.jpg" alt="" class="rounded-circle"
                                                height"82px" width ="84px">
                                        </span>
                                    </div>
                                </a>
                            </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group auth-pass-inputgroup">
                                            <input type="password" class="form-control" placeholder="Enter password"
                                                aria-label="Password" aria-describedby="password-addon" minlength='3'
                        ...
                        <!--  <div class="mt-5 text-center">
                            ...
                            <div>
                                ...
                                </script> Apprise. Crafted with <i class="mdi mdi-heart text-danger"></i> by OfferPlant</p>
                            </div>
                        </div> -->
