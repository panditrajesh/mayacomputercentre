                            ...
                            <div class="card-body pt-0"> 
                                ...
                                <div class="p-2">
                                    ...
                                    <form class="form-horizontal" method="post">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="user_name" class="form-label">Center Code</label>
                                            <input type="text" class="form-control" name="center_code" placeholder="Enter username" minlength='3' required>
                                        </div>
                
                                        <div class="mb-4">
                                            <label class="form-label">Password</label>
                                            <div class="input-group auth-pass-inputgroup">
                                                <input type="password" class="form-control" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon" minlength='3' name ="mobile" required>
