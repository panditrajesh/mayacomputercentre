...
@section('title', 'Student ID Card List')
@push('custom-css')
	<style type="text/css">
				        ...
				        <tbody>
				        	...
				        	@foreach($student as $data) 
				        		<tr>
				        			...
				        			<td>
				        				<a href="{{ route('view_student_id_card',$data->sl_id) }}" class="btn btn-info btn-sm" title="View ID Card"><i class="fa-solid fa-id-card"></i>&nbsp;View ID Card</a>
				        			</td>
				        		</tr>
				        	@endforeach
				        </tbody>
