                            ...
                            <div class="card-body pt-0"> 
                                ...
                                <div class="p-2">
                                    ...
                                    <form class="form-horizontal" method="post">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="user_name" class="form-label">Registration No</label>
                                            <input type="text" class="form-control" name="reg_no" placeholder="Enter username" minlength='3' required>
                                        </div>
