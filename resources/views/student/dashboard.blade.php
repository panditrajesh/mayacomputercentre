            ...
            <div class="card-body" id="student_view">
                ...
                <div class='row'>
                    ...
                    <div class="col-lg-4  col-md-6 col-sm-6 mt-80">
                        <div class="card  d-flex align-items-center justify-content-center text-light"
                            style='background:#550874;'>
                            <div class="w-100"><img src="{{ asset('center/student_doc/') . '/' . $data->sl_photo }}"
                    ...
                    <div class="col-lg-8  col-md-6 col-sm-6 mt-80">
                        ...
                        <table width="100%" cellpadding='4px' style='border:solid 1px #d2d2d2;'>
                            ...
                            <tr>
                                <td width='190'> <label> Center Code </label> </td>
                                <td> : </td>
                                <td> {{ $data->cl_code }} </td>
                            </tr>
                            <tr>
                                <td width='190'> <label> Center Name </label> </td>
                                <td> : </td>
                                <td> {{ $data->cl_center_name }} </td>
                            </tr>
                            <tr>
                                <td width='190'> <label> Center Address </label> </td>
                                <td> : </td>
                            ...
                            <tr>
                                <td width='190'> <label> Contact Number </label> </td>
                                <td> : </td>
                                <td> 8825148127 </td>
